...
## Corpus Check
- 236 files · ~143,612 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1374 nodes · 2713 edges · 93 communities (83 shown, 10 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 18 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bdb976ab`
...
Cohesion: 0.11
Nodes (19): ChipKey, CHIPS, styles, UI_TO_PILL, compactPrice(), FOLLOW_UP_ROWS, styles, UI_LABEL (+11 more)
...
Cohesion: 0.07
Nodes (45): c, radius, sp, status, StatusKey, t, Button(), ButtonProps (+37 more)
...
Cohesion: 0.06
Nodes (38): { width: SCREEN_WIDTH, height: SCREEN_HEIGHT }, useLocation(), UseLocationResult, GeoJsonFeature, DEFAULT_LOCATION, LandlordLocationPicker(), styles, ListingDetailScreen() (+30 more)
...
Cohesion: 0.06
Nodes (100): NEPAL_CITIES, styles, err(), getErrorMessage(), ok(), Result, DashboardActivity, getLandlordDashboard() (+92 more)
...
Cohesion: 0.20
Nodes (11): useAuth(), EditProfileScreen(), AuthStore, Profile, useAuthStore, LandlordProfileTab(), STATUS_BADGE_STYLES, styles (+3 more)
...
Cohesion: 0.16
Nodes (20): AllApplicantsScreen(), useClerkSupabase(), DetailsSharedScreen(), ShareDetailsScreen(), RequestDetailScreen(), useVisitsStore, LandlordTabsLayout(), FilterKey (+12 more)
...
Cohesion: 0.14
Nodes (14): EMPTY_COPY, OPEN_UI, TabKey, TABS, Props, STATUS_STYLES, VisitStatus, VisitStatusBadge() (+6 more)
...
Cohesion: 0.20
Nodes (13): canTransition(), deriveStatusUi(), PatchLandlord, PatchTenant, Supabase, TenantRow, TRANSITIONS, VisitsState (+5 more)
...
Cohesion: 0.10
Nodes (26): LABEL_TO_CHIP, LandlordVisitsScreen(), initialsOf(), LandlordVisitRequest, TenantVisitRequest, TenantVisitStatusUi, TIME_SLOT_LABELS, VisitStatusLabel (+18 more)
...
Cohesion: 0.10
Nodes (26): DeclineRequestScreen(), REASONS, styles, styles, SLOT_START, styles, SLOT_START, styles (+18 more)
...
- **Why does `useClerkSupabase()` connect `Community 27` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 8`, `Community 9`, `Community 10`, `Community 19`, `Community 21`, `Community 23`, `Community 25`, `Community 36`, `Community 39`, `Community 60`, `Community 64`, `Community 65`, `Community 78`, `Community 88`, `Community 89`, `Community 90`, `Community 92`, `Community 93`, `Community 100`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `ScreenHeader()` connect `Community 6` to `Community 1`, `Community 3`, `Community 100`, `Community 4`, `Community 78`, `Community 19`, `Community 88`, `Community 25`, `Community 90`, `Community 92`, `Community 93`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `PrimaryButton()` connect `Community 0` to `Community 3`, `Community 92`, `Community 78`?**
