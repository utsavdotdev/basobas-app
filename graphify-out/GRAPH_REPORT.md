...
## Corpus Check
- 171 files · ~95,842 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 946 nodes · 1224 edges · 76 communities (65 shown, 11 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `56be170c`
...
1. `ScreenHeader()` - 21 edges
2. `useClerkSupabase()` - 17 edges
3. `expo` - 15 edges
4. `ok()` - 15 edges
5. `err()` - 15 edges
...
- `ConfirmationScreen()` --calls--> `useClerkSupabase()`  [EXTRACTED]
  app/(auth)/confirmation.tsx → src/hooks/useClerkSupabase.ts
- `ConfirmationScreen()` --calls--> `useAuthStore`  [EXTRACTED]
  app/(auth)/confirmation.tsx → src/store/authStore.ts
...
Cohesion: 0.05
Nodes (44): useClerkSupabase(), ProGateState, useProGate(), useProGateStore, EsewaFormFields, PlanId, PurchasePlanState, usePurchasePlan() (+36 more)
...
Cohesion: 0.08
Nodes (23): AuthGate(), LoadingScreen(), styles, maskPhone(), OTPVerificationScreen(), s, countryCodeToFlag(), PhoneEntryScreen() (+15 more)
...
## Knowledge Gaps
- **500 isolated node(s):** `name`, `slug`, `version`, `scheme`, `favicon` (+495 more)
...
- **Why does `ScreenBody()` connect `Community 26` to `Community 17`, `Community 19`, `Community 1`, `Community 31`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `usePropertyStore` connect `Community 5` to `Community 26`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `useClerkSupabase()` connect `Community 1` to `Community 0`, `Community 8`, `Community 4`?**
