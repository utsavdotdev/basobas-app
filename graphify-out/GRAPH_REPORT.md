...
## Corpus Check
- 265 files · ~161,573 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1569 nodes · 3058 edges · 109 communities (98 shown, 11 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 33 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f8c99b8d`
...
1. `useClerkSupabase()` - 88 edges
2. `ok()` - 74 edges
3. `err()` - 72 edges
4. `getErrorMessage()` - 72 edges
5. `c` - 27 edges
6. `font` - 25 edges
...
- `RoleSelectionScreen()` --calls--> `useOnboardingStore`  [EXTRACTED]
  app/(auth)/role.tsx → src/store/onboardingStore.ts
...
Cohesion: 0.13
Nodes (48): err(), getErrorMessage(), ok(), getLandlordDashboard(), geocodePlace(), getPropertiesInBounds(), getPropertiesNear(), reverseGeocodePlace() (+40 more)

### Community 1 - "Pro Gate & Plans"
Cohesion: 0.13
Nodes (12): EsewaFormFields, PlanId, PurchasePlanState, usePurchasePlan(), styles, WEBVIEW_UA, Feature, FEATURES (+4 more)
...
Cohesion: 0.12
Nodes (15): ListingDetailScreen(), FilterTab, FORMATTER, MyPropertiesScreen(), MyPropertiesScreenProps, PropertyCard(), STATUS_STYLES, TABS (+7 more)
...
Cohesion: 0.29
Nodes (6): formatDuration(), styles, VideoUploadCard(), VideoUploadCardProps, VideoUploadCardStatus, VideoSlotState
...
Cohesion: 0.17
Nodes (13): KYCRejectionNotice(), Props, styles, getLatestKYCSubmission(), getUserKYCStatusUi(), KYCInput, KYCResult, formatDateTime() (+5 more)
...
Cohesion: 0.19
Nodes (12): useAuth(), ProGateState, useProGate(), MenuCard(), Props, MenuRow(), Props, useUserStore (+4 more)

### Community 19 - "Property Type Mappers"
Cohesion: 0.08
Nodes (30): countSelected(), DetailRow, MediaItem, NewListingStep4(), parseJSON(), styles, CreatePropertyInput, asRecord() (+22 more)

### Community 20 - "Screen Body Layout"
Cohesion: 0.14
Nodes (19): useClerkSupabase(), useLandlordPendingCount(), useNotificationsRealtime(), useProfileBootstrap(), useVisitRealtime(), LandlordKYCUploadScreen(), createClerkSupabaseClient(), supabasePublic (+11 more)

### Community 21 - "Auth Loading Screens"
Cohesion: 0.10
Nodes (22): AllApplicantsScreen(), DeclineRequestScreen(), REASONS, styles, ScreenBody(), ScreenBodyProps, ScreenBodyWithActionProps, compactPrice() (+14 more)
...
Cohesion: 0.11
Nodes (18): APK_SRC, APP_JSON, argv, BUMP_LEVELS, bumpVersion(), draft, GRADLE, main() (+10 more)

### Community 24 - "Visits Store State"
Cohesion: 0.12
Nodes (27): acceptReschedule(), acceptVisit(), cancelVisitRequest(), CreateVisitRequestInput, declineReschedule(), getVisitRequest(), rejectVisit(), rescheduleVisit() (+19 more)

### Community 25 - "Profile Setup Form"
Cohesion: 0.18
Nodes (10): NEPAL_CITIES, PREFERENCES, ProfileFormValues, profileSchema, ProfileSetupScreen(), styles, useAvatarPicker(), Props (+2 more)

### Community 26 - "Suggest Time Picker"
Cohesion: 0.10
Nodes (27): font, t, Button(), ButtonProps, LABEL_COLORS, styles, Variant, DateTimeRow() (+19 more)
...
Cohesion: 0.16
Nodes (16): NEPAL_CITIES, styles, Result, deleteClerkUser(), deleteStorageFolder(), deleteUserData(), AiValidationContext, ContentVerdict (+8 more)

### Community 30 - "KYC Confirmation Screen"
Cohesion: 0.11
Nodes (15): DashboardActivity, PropertyRow, ReverseGeocodeResult, OnboardingInput, CompositeTypes, Constants, Database, DatabaseWithoutInternals (+7 more)
...
Cohesion: 0.12
Nodes (13): radius, status, StatusKey, Divider(), DividerProps, styles, OutlineButtonProps, styles (+5 more)
...
Cohesion: 0.09
Nodes (30): ChipKey, CHIPS, styles, UI_TO_PILL, styles, styles, styles, FOLLOW_UP_ROWS (+22 more)
...
Cohesion: 0.18
Nodes (11): useProGateStore, ProGateModal(), IconComponent, ProPill(), Props, Size, Variant, Feature (+3 more)
...
Cohesion: 0.30
Nodes (10): submitKYC(), completeOnboarding(), localUriToArrayBuffer(), uploadAvatar(), UploadedAvatar, UploadedKYCDoc, UploadedPropertyPhoto, uploadKYCDocument() (+2 more)

### Community 47 - "Visits Empty States"
Cohesion: 0.09
Nodes (23): EMPTY_COPY, OPEN_UI, TabKey, TABS, c, sp, Card(), CardProps (+15 more)
...
Cohesion: 0.24
Nodes (8): KYCLandlordScreen(), DocTypeChipProps, DocumentUploadZoneProps, KYCTenantScreen(), styles, useDocumentPicker(), useOnboardingStore, DocumentType
...
Cohesion: 0.22
Nodes (7): formatDateTime(), LandlordVerificationScreen(), styles, LandlordVerificationDetail, PrimaryButton(), Props, styles
...
Cohesion: 0.10
Nodes (19): DocumentTypeSelector(), DocumentTypeSelectorProps, KYCDocumentType, Option, OPTIONS, styles, DocumentUploadCard(), DocumentUploadCardStatus (+11 more)

### Community 58 - "Community 58"
Cohesion: 0.22
Nodes (7): RoleCardProps, ROLES, RoleSelectionScreen(), styles, OnboardingEyebrow(), Props, styles
...
Cohesion: 0.33
Nodes (5): MediaItem, MediaStatus, MediaType, NewListingStep3(), styles
...
Cohesion: 0.21
Nodes (11): maskPhone(), OTPVerificationScreen(), s, EditProfileScreen(), DetailsSharedScreen(), ShareDetailsScreen(), AuthStore, Profile (+3 more)
...
Cohesion: 0.22
Nodes (4): ConfirmationScreen(), DetailRowProps, styles, SummaryCardProps
...
Cohesion: 0.13
Nodes (13): DocumentUploadCardProps, pickFromOptions(), styles, styles, UploadPlaceholder(), ContextRules, DOCUMENT_MIME_TYPES, IMAGE_MIME_TYPES (+5 more)

## Knowledge Gaps
- **696 isolated node(s):** `name`, `slug`, `version`, `scheme`, `favicon` (+691 more)
...
- **Why does `useClerkSupabase()` connect `Screen Body Layout` to `Pro Gate & Plans`, `Map Camera & Location`, `Auth & Root Layout`, `Notifications Inbox`, `Landlord Dashboard`, `Listing Detail Amenities`, `KYC Rejection Notice`, `Property Detail Screen`, `Listing Wizard Amenities`, `Property Type Mappers`, `Auth Loading Screens`, `Visit Status & Dates`, `Profile Setup Form`, `Suggest Time Picker`, `Tenant Root Layout`, `Landlord Visits & Requests`, `Property Store Filters`, `Community 42`, `Clerk Auth Migrations`, `Community 44`, `Community 45`, `Visits Empty States`, `Community 49`, `Community 55`, `KYC Benefits List`, `Listing Step 3 Media`, `KYC Electricity Bill Migration`, `Community 82`, `Landlord Verification Sync`, `Home Index`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `ScreenHeader()` connect `AI Preferences Screen` to `Notifications Inbox`, `Landlord Visits & Requests`, `Property Store Filters`, `KYC Rejection Notice`, `Listing Wizard Amenities`, `Visit Status & Dates`, `Community 55`, `KYC Benefits List`?**
