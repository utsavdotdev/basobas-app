    ...
    Tables: {
      ...
      kyc_submissions: {
        Row: {
          ...
          extracted_full_name_local: string | null
          extracted_issue_date: string | null
          extracted_issuer: string | null
          face_match_reasoning: string | null
      ...
      visit_requests: {
        Row: {
          ...
          created_at: string
          id: string
          landlord_follow_up_at: string | null
          landlord_follow_up_note: string | null
          landlord_follow_up_outcome: string | null
          landlord_id: string
          landlord_response_note: string | null
          note: string | null
          previous_requested_date: string | null
          previous_time_slot:
            | Database["public"]["Enums"]["time_slot_enum"]
            | null
          property_id: string
          ...
          tenant_follow_up_at: string | null
    ...
    Functions: {
      ...
      insert_kyc_submission: {
        Args: {
          ...
          p_selfie_image_path?: string
          p_utility_bill_back_path?: string
          p_utility_bill_type?: string
      ...
      mark_past_visits_completed: {
        Args: { p_force?: boolean; p_visit_id?: string }
        Returns: number
      }
      notify_follow_up_requested: {
        Args: { v_visit: Database["public"]["Tables"]["visit_requests"]["Row"] }
        Returns: undefined
      }
      ...
      submit_landlord_follow_up: {
        Args: { p_note?: string; p_outcome: string; p_visit_id: string }
        Returns: {
          completed_at: string | null
          created_at: string
          id: string
      ...
      submit_tenant_follow_up: {
        Args: { p_note?: string; p_response: string; p_visit_id: string }
        Returns: {
          completed_at: string | null
          created_at: string
          id: string
      ...
      visit_window_passed: {
        Args: {
          ...
          p_time_slot: Database["public"]["Enums"]["time_slot_enum"]
        }
        Returns: boolean
      }
    }
